! function(r) {
    var e = r.Shopify,
        ...
        p = {
            ...
            sendPayloadToServer: function(e, r) {
                ...
                try {
                    t.open("POST", "https://api-production.polaranalytics.com/pixel"), t.setRequestHeader("Content-Type", "application/json;charset=UTF-8"), t.send(JSON.stringify(e))
                } catch (t) {
    ...
    try {
        ...
        o.errors.push(JSON.stringify(t.stack)), p.sendPayloadToServer(o, 5)
    }
}(window);